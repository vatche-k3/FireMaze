...
def bfs_search(start, goal):
    ...
    while fringe:
        ...
        if current == goal:
            ...
            if maze[current[0]][current[1]] != BFS_VISITED_VALUE:
                generate_valid_children_B(current, fringe)
                # mark the coordinate as visited
                maze[current[0]][current[1]] = BFS_VISITED_VALUE
        ...
        if row in range(0, dim):
            ...
            if(col in range(0,dim)):
                ...
                if(maze[row][col] != OBSTACLE_VALUE):
                    ...
                    if(maze[row][col] != BFS_VISITED_VALUE):
